<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"/www/wwwroot/nhk.cloudbing.online/public/../app/admin/view/appv1/user.html";i:1657793760;s:65:"/www/wwwroot/nhk.cloudbing.online/app/admin/view/public/foot.html";i:1657691353;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<body style="padding:10px;">
  <div class="tplay-body-div">
    ...
    <table class="layui-table" lay-size="sm">
    	...
    	<br />
    	<hr />
    	<p class="el-button el-button--primary is-plain">由快科技提供技术支持</p><br /><br />
    	<div class="layui">
