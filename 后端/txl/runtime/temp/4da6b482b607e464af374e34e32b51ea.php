<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"/www/wwwroot/20.187.70.78/public/../app/admin/view/common/login.html";i:1657700427;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
  ...
  <script src="http://20.187.70.78:2022/js/jquery.min.js"></script>
  <style>
        * { margin: 0; padding: 0; }
        html { height: 100%; }
        body { height: 100%; background: #fff url(http://20.187.70.78:2022/logins/images/backgroud.png) 50% 50% no-repeat; background-size: cover;}
        .dowebok { position: absolute; left: 50%; top: 50%; width: 430px; height: 550px; margin: -300px 0 0 -215px; border: 1px solid #fff; border-radius: 20px; overflow: hidden;}
        .logo { width: 104px; height: 104px; margin: 50px auto 80px; background: url(http://20.187.70.78:2022/logins/images/login.png) 0 0 no-repeat; }
        .form-item { position: relative; width: 360px; margin: 0 auto; padding-bottom: 30px;}
        .form-item input { width: 288px; height: 48px; padding-left: 70px; border: 1px solid #fff; border-radius: 25px; font-size: 18px; color: #fff; background-color: transparent; outline: none;}
        .form-item button { width: 360px; height: 50px; border: 0; border-radius: 25px; font-size: 18px; color: #1f6f4a; outline: none; cursor: pointer; background-color: #fff; }
        #username { background: url(http://20.187.70.78:2022/logins/images/emil.png) 20px 14px no-repeat; }
        #password { background: url(http://20.187.70.78:2022/logins/images/password.png) 23px 11px no-repeat; }
