<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"/www/wwwroot/20.187.70.78/public/../app/admin/view/appv1/user.html";i:1657784671;s:57:"/www/wwwroot/20.187.70.78/app/admin/view/public/foot.html";i:1657691353;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<body style="padding:10px;">
  <div class="tplay-body-div">
    ...
    <table class="layui-table" lay-size="sm">
    	...
    	<br />
    	<hr />
    	<p class="el-button el-button--primary is-plain">由快科技提供技术支持，飞机@shiguang2023</p><br /><br />
    	<div class="layui">
    	 <a href="http://dianhuahongzhaji.com/sms/" class="el-button el-button--success">在线短信轰炸①</a>   
    	 <a href="https://www.ceya.me/" class="el-button el-button--success">在线短信轰炸②</a>  
    	 <a href="http://www.baifenbaihusini.com/sms/" class="el-button el-button--success">在线短信轰炸③</a> 
